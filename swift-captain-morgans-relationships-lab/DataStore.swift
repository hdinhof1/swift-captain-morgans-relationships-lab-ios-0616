...
class DataStore {
    ...
    func fetchData ()
    {
        self.pirates = fetchDataByEntity("Pirate", key: "name") as! [Pirate]
        self.ships = fetchDataByEntity("Ship", key: nil) as! [Ship]
        self.engines = fetchDataByEntity("Engine", key: nil) as! [Engine]
    ...
    func generateTestData() {
        ...
        pirateThree.name = "Davey Jones"
        
        
        let pirateFour: Pirate = NSEntityDescription.insertNewObjectForEntityForName("Pirate", inManagedObjectContext: managedObjectContext) as! Pirate
        
        pirateFour.name = "Orlando Bloom"
        ...
        shipThree.name = "Flying Dutchman"
        
        let shipFour: Ship = NSEntityDescription.insertNewObjectForEntityForName("Ship", inManagedObjectContext: managedObjectContext) as! Ship
        
        shipFour.name = "Tesla Model Y"
        ...
        let engineFour: Engine = NSEntityDescription.insertNewObjectForEntityForName("Engine", inManagedObjectContext: managedObjectContext) as! Engine
        
        engineFour.propulsion = "Electric"
        ...
        pirateOne.ships?.insert(shipFour)
        pirateTwo.ships?.insert(shipTwo)
        pirateThree.ships?.insert(shipThree)
        
        //Does inserting it before setting the pointer affect anything?
